...
typedef NS_ENUM (NSUInteger, HCYCollectionViewLayoutItemRenderDirection) {
    HCYCollectionViewLayoutItemRenderDirectionShortestFirst,
    HCYCollectionViewLayoutItemRenderDirectionLeftToRight,
    HCYCollectionViewLayoutItemRenderDirectionRightToLeft
};
...
#pragma mark - HCYCollectionViewLayoutDelegate

@class HCYCollectionViewLayout;

/**
 *  The HCYCollectionViewLayoutDelegate protocol defines methods that let you coordinate with a
 *  HCYCollectionViewLayout object to implement a waterfall-based layout.
 ...
 */
@protocol HCYCollectionViewLayoutDelegate <UICollectionViewDelegate>
@required
/**
...
#pragma mark - HCYCollectionViewLayout

/**
 *  The HCYCollectionViewLayout class is a concrete layout object that organizes items into waterfall-based grids
 ...
 *  in each section. That delegate object must conform to the `HCYCollectionViewLayoutDelegate` protocol.
 *
 ...
 *
 *  @note HCYCollectionViewLayout doesn't support decoration view, and it supports vertical scrolling direction only.
 */
@interface HCYCollectionViewLayout : UICollectionViewLayout
 ...
 *  @discussion
 *    The direction in which each item is rendered. This could be left to right (HCYCollectionViewLayoutItemRenderDirectionLeftToRight), right to left (HCYCollectionViewLayoutItemRenderDirectionRightToLeft), or shortest column fills first (HCYCollectionViewLayoutItemRenderDirectionShortestFirst).
 *
 *    Default: HCYCollectionViewLayoutItemRenderDirectionShortestFirst
 */
@property (nonatomic, assign) HCYCollectionViewLayoutItemRenderDirection itemRenderDirection;

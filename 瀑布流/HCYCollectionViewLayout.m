...
@interface HCYCollectionViewLayout ()
/// The delegate will point to collection view's delegate automatically.
@property (nonatomic, weak) id <HCYCollectionViewLayoutDelegate> delegate;
...
@implementation HCYCollectionViewLayout
...
- (void)setItemRenderDirection:(HCYCollectionViewLayoutItemRenderDirection)itemRenderDirection {
...
- (id <HCYCollectionViewLayoutDelegate> )delegate {
    return (id <HCYCollectionViewLayoutDelegate> )self.collectionView.delegate;
}
...
- (void)commonInit {
    ...
    _itemRenderDirection = HCYCollectionViewLayoutItemRenderDirectionShortestFirst;
}
...
- (void)prepareLayout {
    ...
    NSAssert([self.delegate conformsToProtocol:@protocol(HCYCollectionViewLayoutDelegate)], @"UICollectionView's delegate should conform to HCYCollectionViewLayoutDelegate protocol");
...
- (NSUInteger)nextColumnIndexForItem:(NSInteger)item inSection:(NSInteger)section {
    ...
    switch (self.itemRenderDirection) {
        case HCYCollectionViewLayoutItemRenderDirectionShortestFirst:
            index = [self shortestColumnIndexInSection:section];
            break;
            
        case HCYCollectionViewLayoutItemRenderDirectionLeftToRight:
            index = (item % columnCount);
            break;
            
        case HCYCollectionViewLayoutItemRenderDirectionRightToLeft:
